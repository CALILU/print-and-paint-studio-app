...
# 
# 
# Programa para pasar del archivo csv
#
# 
#**************************************************************************************
...
try:
    ...
    print("Intenta verificar que estés ejecutando este script en el entorno correcto (Railway)")
    exit(1)

# Ruta del archivo CSV (ajustar para entorno local)
csv_path = os.environ.get('CSV_PATH', 'fixed_printpaintstudio_videos.csv')
