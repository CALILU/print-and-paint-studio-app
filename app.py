...
from models import db, User, Video, Favorite, Technique, Category, Paint, PaintBackup, PaintImage, PriceSource, PriceHistory
            ...
            try:
                ...
                if hasattr(paint, 'to_dict'):
                    ...
                    paint_dict = {
                        ...
                        'shelf_position': getattr(paint, 'shelf_position', None),
